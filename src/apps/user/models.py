...
from antd_pro.core.schemas import ModelSchema


@ModelSchema(namespace='user')
...
class User(BaseModel):
    ...
    avatar = models.ImageField(
        verbose_name="头像", null=True, blank=True, upload_to="images"
    )
    resume = models.FileField(
        verbose_name="简历", null=True, blank=True, upload_to="files"
    )
